...
public class JoinedProduct {
    ...
    public String toString() {
        return "JoinedProduct{" + "productName='" + productName + '\'' + ", size='" + size + '\'' + ", milk=" + milk + ", whip=" + whip + ", servSizeMl=" + servSizeMl + ", calories=" + calories + ", totalFatG=" + totalFatG + ", saturatedFatG=" + saturatedFatG + ", transFatG='" + transFatG + '\'' + ", cholesterolMg=" + cholesterolMg + ", sodiumMg=" + sodiumMg + ", totalCarbsG=" + totalCarbsG + ", fiberG='" + fiberG + '\'' + ", sugarG=" + sugarG + ", caffeineMg=" + caffeineMg + '}';
    }
}